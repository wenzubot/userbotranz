...
thumb_image_path = ayiin.TEMP_DOWNLOAD_DIRECTORY + "/thumb_image.jpg"
name = "Profile Photos"


@ayiinCmd(pattern="app(?: |$)(.*)")
async def apk(e):
...
async def rename_upload(event):
    ...
    if event.reply_to_msg_id:
        ...
        to_download_directory = ayiin.TEMP_DOWNLOAD_DIRECTORY
...
cmdHelp.update(
    {
        ...
        \n  »  **Kegunaan : **Untuk menendang user dari grup secara spesifik\
