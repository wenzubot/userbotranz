...
from pyAyiin.lib.tools import bash, deEmojify
...
async def ngethreat(event):
    ...
    if replied.media:
        ...
        await event.edit("reply to a supported media file")
        return
    download_location = await ayiin.download_media(replied, ayiin.TEMP_DOWNLOAD_DIRECTORY)
...
async def FakeGoogleSearch(event):
    ...
    font1 = ImageFont.truetype(
        "assets/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype(
        "assets/ProductSans-Light.ttf", 23)
