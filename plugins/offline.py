...
from pyAyiin.database.permit import isApproved, getModePermit

from . import AFKREASON
...
async def set_afk(afk_e):
    ...
    if ayiin.BOTLOG_CHATID:
        await afk_e.client.send_message(ayiin.BOTLOG_CHATID, f"#OFF\n**✧ {owner} Telah OFF!**")
    ISAFK = True
...
@ayiinHandler(incoming=True, func=lambda e: e.is_private)
