...
cmdHelp.update(
    {
        "anilist": f"**Plugin : **`anilist`\
        \n\n  »  **Perintah :** `{cmd}anichar` <character name>\
        \n  »  **Kegunaan : **Untuk mencari informasi tentang karakter. \
        \n\n  »  **Perintah :** `{cmd}airing` <anime name>\
        \n  »  **Kegunaan : **Untuk mencari informasi tentang anime.\
        \n\n  »  **Perintah :** `{cmd}animanga` <manga name>\
        \n  »  **Kegunaan : **Untuk mencari informasi tentang manga.\
        \n\n  »  **Perintah :** `{cmd}anilist` <anime name>\
        \n  »  **Kegunaan : **Untuk mencari informasi tentang anime.\
    "
    }
)